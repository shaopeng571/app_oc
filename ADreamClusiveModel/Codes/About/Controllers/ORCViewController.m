...
@interface ORCViewController ()<UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate>
...
//    [[AipOcrService shardService] authWithAK:@"9xZ2e8hO25slP823HENCvDEb" andSK:@"2DmanuG7X5stp3XWwzRYSFsNDsQfhUOP"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *cellID = @"OCRCell";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell==nil) {
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
        cell.textLabel.font = kGetThemeFont(13);
        cell.textLabel.textColor = kGetThemeColor;
    }
